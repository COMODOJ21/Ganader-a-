...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    pro=mod.duracion_promedio_peliculas(p1, p2, p3, p4, p5)
    print(pro)
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    anio=int(input('dame un año de refereancia: '))
    estre=mod.encontrar_estrenos(p1, p2, p3, p4, p5, anio)
    print(estre)
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    xxx=mod.cuantas_peliculas_18_mas(p1, p2, p3, p4, p5)
    print(xxx)
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    pelicula = mod.encontrar_pelicula(nombre,p1,p2,p3,p4,p5) #es un diccionario
    ...
    yeii=int(input('Quiere tener en cuenta el control horario 1 o 2: 1=Si  2=No '))
    control_horario=False
    if yeii==1:
        control_horario=True
    print(control_horario)
    reag=mod.reagendar_pelicula(pelicula, nueva_hora, nuevo_dia, control_horario, p1, p2, p3, p4, p5)
    print(reag)
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        print("No hay ninguna pelicula con este nombre")
   # TODO: Completar
    edad_invitado=int(input('Que edad tiene el invitado: '))
    yei=int(input('¿Cuenta con la autorizacion de los padres? 1 o 2: 1=Si  2=No '))
    autorizacion_padres=False
    if yei==1:
        autorizacion_padres=True
    invi=mod.decidir_invitar(pelicula, edad_invitado, autorizacion_padres)
    print(invi)
